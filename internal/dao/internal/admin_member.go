...
// AdminMemberDao is the data access object for the table zz_admin_member.
...
// AdminMemberColumns defines and stores column names for the table zz_admin_member.
...
// adminMemberColumns holds the columns for the table zz_admin_member.
