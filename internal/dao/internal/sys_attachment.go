...
// SysAttachmentDao is the data access object for the table zz_sys_attachment.
...
// SysAttachmentColumns defines and stores column names for the table zz_sys_attachment.
...
// sysAttachmentColumns holds the columns for the table zz_sys_attachment.
