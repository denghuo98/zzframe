...
// SysLoginLogDao is the data access object for the table zz_sys_login_log.
...
// SysLoginLogColumns defines and stores column names for the table zz_sys_login_log.
...
// sysLoginLogColumns holds the columns for the table zz_sys_login_log.
