...
// AdminRoleMenuDao is the data access object for the table zz_admin_role_menu.
...
// AdminRoleMenuColumns defines and stores column names for the table zz_admin_role_menu.
type AdminRoleMenuColumns struct {
	RoleId string // 角色ID
	MenuId string // 菜单ID
}

// adminRoleMenuColumns holds the columns for the table zz_admin_role_menu.
